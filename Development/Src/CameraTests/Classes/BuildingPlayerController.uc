class BuildingPlayerController extends CameraPlayerController;

var BuildingObject CurrentCube;
...
state Building extends PlayerWalking
{
    exec function Use()
    {
...
{
    return self.IsInState('Building') || self.GetStateName() == 'Building';
}
